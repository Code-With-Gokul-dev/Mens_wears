            ...
            <section className='grid md:grid-cols-2 min-h-[calc(100vh-5rem)] border-b border-gray-500'>
                ...
                <div className=' my-10 space-y-10  md:p-0 p-10'>
                    ...
                    <div className='justify-items-center '>
                     ...
                     <div className='absolute top-40 left-10 bg-white transition-all ease-in-out duration-300 max-w-11 hover:max-w-75 overflow-hidden text-black  group/slide rounded-full flex items-center'>
                        <div className='shrink-0 p-2'>
                             <LogIn className='stroke-pink-500'  />
                        </div>
                         <div className='opacity-0 -translate-x-4 pointer-events-none group-hover/slide:opacity-100 group-hover/slide:translate-x-0 group-hover/slide:pointer-events-auto transition-all duration-300 ease-out whitespace-nowrap'>
                            <Link href={"/sign-in"} className='group-hover/slide:translate-x-5 group-hover/slide:underline font-caveat font-medium text-gray-800 underline-offset-4 pr-2'>
                ...
                <div className='bg-pink-600 md:block hidden relative py-5 px-10'>
                    ...
                    <Link href="/" className='text-4xl text-white flex justify-end items-center font-bricolage font-semibold group/back '>
                     ...
                     {/* Content */}
                     <div className=' w-100 h-50 rounded-md py-20 '>

                       <h1 className='font-bricolage font-semibold leading-snug text-5xl text-gray-100 text-shadow-md text-shadow-black/50 '>
                         Your Style Our <span className='text-lime-400 text-7xl text-shadow-black text-shadow-lg p-2 z-999'>fashion !!</span>
                       </h1>

                         
                     </div>
                    {/* Decorative img */}
                    <div className='absolute top-[35%] drop-shadow-md   drop-shadow-white left-[40%] bg-black/90 border-4 border-white    rounded-b-full rounded-tl-full  p-3 w-fit h-fit hadow-inner shadow-black '>
                        ...
                        <div className='w-100 h-120  absolute top-[-33%] drop-shadow-md  drop-shadow-white/20 hover:scale-115 transition-all duration-300 ease-in-out  '>
                            <Image alt="sign-up image" src="/bg_img/register_img.png" fill size="222" className='object-cover' />
