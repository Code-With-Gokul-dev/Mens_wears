                ...
                <div className='bg-pink-600 md:block hidden relative py-5 px-10'>
                    ...
                    <div className=' w-100 h-50 rounded-md py-15 '>
                       ...
                       <div className='w-72 text-wrap text-shadow-white text-white font-bricolage font-medium py-2'>
                        <p>Join the modern <span className='text-black font-semibold bg-white px-2'>gentleman’s club.</span> Create your account to unlock <span className='bg-lime-400 text-black font-semibold'>
                            personalized styling, exclusive drops</span>, and early access to the latest trends.</p>
                       </div>
                    </div>
                    {/* Decorative img */}
                    <div className='absolute top-[35%] drop-shadow-md   drop-shadow-white left-[40%] bg-black/90 border-4 border-white    rounded-b-full rounded-tl-full  p-3 '>
                        ...
                        <div className='w-100 h-120  absolute top-[-33%] drop-shadow-md  drop-shadow-white/20 scale-110 '>
